...
import pytest
from source_revel.source import RevelStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RevelStream, "path", "v0/example_endpoint")
    mocker.patch.object(RevelStream, "primary_key", "test_primary_key")
    mocker.patch.object(RevelStream, "__abstractmethods__", set())
